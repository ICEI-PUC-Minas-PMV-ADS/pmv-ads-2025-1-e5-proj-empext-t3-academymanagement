...
import { BackgroundShape } from '../../components/illustration/backgroundShape';

const Illustration = ({ ...other }: BoxProps) => {
...
export const ForbiddenIllustration = memo(Illustration);
